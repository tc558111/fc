...
public class FTOFOccupancyApp extends FCApplication {
    ...
    public void updateCanvas(DetectorDescriptor dd) {
        ...
        H2D h2a = ftofPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,1,0); h2a.setYTitle(otab[0]+"PMTs") ; h2a.setXTitle(otab[0]+"PMT"+lab4[0]);
        H2D h2b = ftofPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,2,0); h2b.setYTitle(otab[1]+"PMTs") ; h2b.setXTitle(otab[1]+"PMT"+lab4[0]);
        ...
        for(int il=1;il<3;il++){
            ...
            canvas.cd(il+1); h1 = ftofPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,il,0).projectionY(); h1.setXTitle(xlab); h1.setFillColor(col0); canvas.draw(h1);
            }   
