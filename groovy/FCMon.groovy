...
public class FCMon extends DetectorMonitoring {
	...
	public void processEvent(EvioDataEvent event) {
                ...
                def nh        = new int[6][9];
		def strr      = new int[6][9][68]; 
		def adcr      = new int[6][9][68];
		def tdcr      = new int[6][9][68];
		def rs        = new int[9];
		def ad        = new int[9];
		def td        = new int[9];
		def good_lay  = new boolean[9]; 
		def good_uv   = new boolean[3];
		def good_uw   = new boolean[3];
		def good_vw   = new boolean[3];
		def good_uvw  = new boolean[3];		
		def good_uwt  = new boolean[3];
		def good_vwt  = new boolean[3];
		def good_wut  = new boolean[3];
		def good_uwtt = new boolean[3];
		def good_vwtt = new boolean[3];
		def good_wutt = new boolean[3];
        ...
        // Histo: U vs V, U vs W, V vs W (used for detector map)
                ...
                double td1=ad[ic*3+0] ; double td2=ad[ic*3+1] ; double td3=ad[ic*3+2];
