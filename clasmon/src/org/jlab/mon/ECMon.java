...
public class ECMon extends JFrame implements IDetectorListener, IDetectorProcessor {
	...
	public void initDetector(int is1, int is2, String[] args) {
		...
		this.view.addDetectorLayer(dv10);
		this.view.addDetectorLayer(dv11);
		this.view.addDetectorLayer(dv12);
		this.view.addDetectorLayer(dv13);
		this.view.addDetectorLayer(dv14);
		this.view.addDetectorLayer(dv15);
