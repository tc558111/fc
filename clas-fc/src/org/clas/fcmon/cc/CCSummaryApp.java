...
public class CCSummaryApp extends FCApplication {

    public CCSummaryApp(String name, CCPixels ccPix) {
        super(name,ccPix);    
     }
    ...
    public void updateCanvas(DetectorDescriptor dd) {
        ...
        for(int iip=0;iip<nstr;iip++) {
            ...
            canvas.cd(iip); h = ccPix.strips.hmap2.get("H2_CCa_Hist").get(is+1,il,0).sliceY(iip); 
            h.setXTitle(alab); h.setTitle(""); h.setFillColor(col1); canvas.draw(h);
        }
